        ...
        {userDetails && (
          <View>
            ...
            {userDetails.geekforgeeks === "" ? (
              ...
              <View style={styles.card}>
                <View style={styles.cardContent}>
                  <Image source={require('../assets/gfg1.png')} style={styles.image} />
                ...
                <View style={styles.inputContainer}>
                  ...
                  />
                  <TouchableOpacity style={styles.addButton} onPress={() => handleAddUsername('geekforgeeks', username2)}>
                  <Text style={styles.buttonText}>Add</Text>
                  </TouchableOpacity>
                </View>
              </View>
                ...
                <View style={styles.card}>
                  ...
                  <TouchableOpacity style={styles.viewProfileButton} onPress={()=>handleViewProfile(userDetails.geekforgeeks)}>
                    <Text style={styles.buttonText}>View Profile</Text>
                  </TouchableOpacity>
                </View>
              )}
